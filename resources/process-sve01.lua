...
function update_table( passedt )
    ...
    passedt["cycleway:left"] = Find("cycleway:left")
    passedt["cycleway:right"] = Find("cycleway:right")
    ...
    passedt["highway_authority_ref:signed"] = Find("highway_authority_ref:signed")
    ...
    passedt.indoor_seating = Find("indoor_seating")
    ...
    passedt["railway:traffic_mode"] = Find("railway:traffic_mode")
    passedt["razed:amenity"] = Find("razed:amenity")
    passedt["razed:railway"] = Find("razed:railway")
    ...
    passedt["seamark:name"] = Find("seamark:name")
...
-- ------------------------------------------------------------------------------
    ...
    passedt.war_memorial = Find("war_memorial")
...
-- ----------------------------------------------------------------------------
                if (( passedt.amenity == "ferry_terminal" ) or
                    ...
                    if (( passedt.amenity == "shelter"                     ) or
                        ...
                        ( passedt.amenity == "playground_playhouse"        ) or
