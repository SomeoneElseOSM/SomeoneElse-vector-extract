...
## As yet unreleased
Farmland and forest in the `land1` layer (which is most of it) is now extracted at a range of zoom levels between 8 and 14, with names extracted between 10 and 14.
